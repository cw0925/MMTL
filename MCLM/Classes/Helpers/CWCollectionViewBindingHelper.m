//
//  CWCollectionViewBindingHelper.m
//  MCLM
//
...
#import "CWCollectionViewBindingHelper.h"
#import "CWBindViewDelegate.h"

@interface CWCollectionViewBindingHelper ()

@property (nonatomic, strong) NSString * cellIdentifier;

@end

@implementation CWCollectionViewBindingHelper
//RAC
...
- (UICollectionViewCell *)dequeueCellAndBindInCollectionView:(UICollectionView *)collectionView indexPath:(NSIndexPath *)indexPath {
    id<CWBindViewDelegate> cell = [collectionView dequeueReusableCellWithReuseIdentifier:_cellIdentifier forIndexPath:indexPath];
