...
#import "CWTableViewBindingHelper.h"
#import "CWBindViewDelegate.h"

@interface CWTableViewBindingHelper ()

@property (nonatomic, copy) NSString * cellIdentifier;

@end

@implementation CWTableViewBindingHelper
...
- (UITableViewCell *)dequeueCellAndBindInTable:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath {
    id<CWBindViewDelegate> cell = [tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
